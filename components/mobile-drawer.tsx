    ...
    return(
        <div id='mobile-sidenav'>
            ...
            <div id='sidenav-container'>
                <Link className={`mobile-nav nav-item ${pathname === '/' ? 'active' : ''}`}
                href="/" title='Home'
                onClick={handleClose}><HiHome size={25} className='sidenav-icon'/>Home
                </Link>
                <p style={{color:"#fff", fontSize:'15pt', margin:'0.5rem'}}>Services</p>
                <Link className={`mobile-nav nav-item service-item ${pathname === '/services/parking' ? 'active' : ''}`}
