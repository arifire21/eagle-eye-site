  ...
  return (
    ...
    <div className='main-padding'>
        <div className='mainContainer'>
          <Image src={Logo} alt='Eagle Eye LLC.' width={400} height={400}/>
          ...
          <div className='sbsContainer'>
            <section className='sbsText'>
              <p>If you have a situation with vehicles parking on your property where they should not be parking, then that is when our services come in and you allow Eagle Eye Monitoring, LLC. to work for you. We are a licensed and insured parking enforcement company. We specialize in helping property owners, managers, and homeowner associations with their parking issues 24 hours a day, 7 days a week.</p>
              <p>Using our software, we provide streamlined online registration, virtual permitting, and record-keeping. Property managers and owners are able to access our programs at any time, and opt-in to mobile alerts, to stay informed about their properties’ security.</p>

              <CTAButton variant='primary' text='Learn More'/>

              <p>Our goal is to ensure that your property is maintained in compliance with all local and state parking ordinances, as well as your parking rules. We take the hassle of finding all the vehicles in violation out of your hands. We work hand and hand with various local tow truck companies. Eagle Eye will be there as your representative any time day or night.</p>
            </section>
            <Image src={Site1} alt='parking-lot' width={470} height={355}/>
          </div>
          ...
          <div className='sbsContainer'>
              <Image src={Site2} alt='parking-lot-text' width={395} height={225}/>
              <section className='sbsText'>
                ...
                <div className='sbsContainer sbsItem'>
